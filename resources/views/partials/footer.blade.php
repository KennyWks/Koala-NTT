...
<footer id="footer">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-contact">
                    <h3>Koala NTT<span>.</span></h3>
                    <p>
                        Timor Raya Street Km 10 <br>
                        Kupang City, East Nusa Province<br>
                        Indonesia <br><br>
                        <strong>Phone:</strong> +1 5589 55488 55<br>
                        <strong>Email:</strong> koalantt2023@gmail.com<br>
                    </p>
                </div>
    ...
    <div class="container py-4">
        <div class="copyright">
            &copy; Copyright <strong><span>Koala NTT</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            ...
            Designed by <a href="https://bootstrapmade.com/">BootstrapMade</a> and Modified by <a href="https://github.com/KennyWks">KennyWks</a>
        </div>
    </div>
</footer><!-- End Footer -->
